                ...
                <Grid item xs={16} sm={3}>
                        <Paper elevation={false} sx={{  padding: 2 }} >
                            <Stack gap={2}>
                                ...
                                <Slider min={10} max={1000} valueLabelDisplay='on' value={priceRange} onChange={(event, newValue, activeThumb)=>{
                                    if(activeThumb==0){
                                ...
                                <Slider min={1} max={5} valueLabelDisplay value={guestsNumber} marks={guestsNumberMarks} onChange={(event, newValue)=>{
                            ...
                            <Button fullWidth variant="contained" onClick={() => { handleAdd(); setOpenAdd(false) }}>提交</Button>
