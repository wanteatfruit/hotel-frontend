    ...
    return (
        <Layout>
            ...
            >
                ...
                <Box sx={{backgroundColor:'purple', display:'flex', paddingY:'120px', justifyContent:'center'}}>
                    <BranchIntro name={id} url={"https://images.unsplash.com/photo-1608381742187-ea4b48c56630?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1224&q=80"} description={'改革开放的起点'} />
                </Box>
