...
import MapBD from "./country-map";

const theme = createTheme();

export default function Home() {
    const svgTransition = {duration: 4, yoyo: Infinity, ease: "easeInOut"};
    return (
        <>
            {/*<Head>*/}
            {/*    <script type="text/javascript"*/}
            {/*            src="http://api.map.baidu.com/api?v=3.0&ak=hlW9IzjSp9NTxIritm0d7OQMlivYKlyl" async>*/}
            {/*    </script>*/}
            {/*</Head>*/}
